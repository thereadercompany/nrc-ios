...
extension SwinjectStoryboard {
    class func setup() {
        ...
        container.register(BlockDecoder.self) { _ in CustomBlockDecoder() }
        ...
        container.register(CellFactory.self) { r in CustomCellFactory(trackerFactory: r.resolve(TrackerFactory.self)!) }
